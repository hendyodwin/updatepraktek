...
class ChatScreen extends StatelessWidget {
  const ChatScreen({Key? key, required this.roomId, required this.orderId})
      : super(key: key);
  final String roomId;
  ...
  Widget build(BuildContext context) {
    ...
    controller.isDoctorScreen.value = false;
                              ...
                              for (var message in messages) {
                                ...
                                if (messageType == 'txt') {
                                  ...
                                  final messageBubble = MessageBubble(
                                      ...
                                      photo: message['product']['photos'][0],
                                      price: double.parse(
        ...
        child: Column(
          ...
          children: <Widget>[
            Material(
              ...
              elevation: 0,
              color: isMe == true ? kSecondary : Colors.grey.shade100,
              child: Padding(
                                      ...
                                      child: FittedBox(
                                        ...
                                        child: SizedBox(
                                          height: controller.controllerVideo
                                              .value.size.height,
                                          width: controller
                                              .controllerVideo.value.size.width,
                                          child: VideoPlayer(
