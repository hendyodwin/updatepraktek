...
class DoctorJoinRoom extends StatefulWidget {
  const DoctorJoinRoom({Key? key, required this.appointment}) : super(key: key);
  final Map appointment;

  @override
  _DoctorJoinRoomState createState() => _DoctorJoinRoomState();
}

class _DoctorJoinRoomState extends State<DoctorJoinRoom> {
  ...
  void initState() {
    ...
    JitsiMeet.addListener(JitsiMeetingListener(
        ...
        onError: _onError));
    _db.collection('video').doc(widget.appointment['attributes']['room_id']).update(
        {'doctor_joined':true});
    _joinMeeting();
  }
  ...
  Widget build(BuildContext context) {
    ...
    _db.collection('video').doc(widget.appointment['attributes']['room_id']).snapshots();
    // Designing the page
    return Scaffold(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                  ...
                  child: SizedBox(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: NetworkImage(
                        widget.appointment['attributes']['profile']['data']['attributes']['profile_picture']['data']
                        ['attributes']['formats']['medium'] ==
                            null
                            ? widget.appointment['attributes']['profile']['data']
              ...
              SizedBox(height: 16,),
              Text(isLeft?'You left the consult, do you want to rejoin?':'Waiting for ${widget.appointment['attributes']['profile']['data']
              ['attributes']['name']}', style: TextStyle(color:kText2),),
