...
class DoctorBookingDetailPatient extends StatelessWidget {
  const DoctorBookingDetailPatient(
      {Key? key, required this.doctor, required this.slot})
      : super(key: key);
  final int doctor;
  final int slot;
  @override
  Widget build(BuildContext context) {
    Get.find<MainController>().trackEventMixPanel('doctor_detail');
    final BookingDetailController controller =
        Get.put(BookingDetailController());
    controller.doctorId.value = this.doctor;
    controller.slotId.value = this.slot;
    controller.bookingType.value = 'video';
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              controller.slot.length > 0
                                                  ? 'Rp. ${currencyFormatter.format(controller.slot['attributes']['price'])}'
                                                  : '-',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 18),
